    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Resources =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            [English] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["Dashboard.Body"] = "Safe ECU Calibration Manager is currently at Phase 4: programmer adapters.\n\nThe application has a desktop shell, main navigation, local logging, global error handling, SQLite persistence, vehicle records and safe programmer capability reporting.\n\nDangerous capabilities remain disabled: ECU writing, flashing, direct Galletto 1260 control, real map modification and any technical bypass.",
            ...
            [Portuguese] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["Dashboard.Body"] = "Safe ECU Calibration Manager esta atualmente na Fase 4: adapters de programador.\n\nA aplicacao ja tem shell desktop, navegacao principal, logging local, tratamento global de erros, persistencia SQLite, registos de veiculos e apresentacao segura de capacidades de programadores.\n\nFuncionalidades perigosas permanecem desativadas: escrita ECU, flashing, controlo direto do Galletto 1260, alteracao real de mapas e qualquer bypass tecnico.",
